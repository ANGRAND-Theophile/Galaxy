...
class MainWidget(RelativeLayout):
    ...
    def init_audio(self):
        ...
        self.sound_music1 = SoundLoader.load('../res/audio/music1.wav')
        ...
        self.sound_gameover_impact.volume = .2
    ...
    def generate_tiles_coordinates(self):
        ...
        for i in range(len(self.tiles_coordinates), self.NB_TILES):
            ...
            # 1 -> à droite
            # 2 -> à gauche
            start_index = -int(self.V_NB_LINES / 2) + 1     # ligne vertical la plus à gauche
            end_index = start_index + self.V_NB_LINES - 1   # ligne vertical la plus à droite
